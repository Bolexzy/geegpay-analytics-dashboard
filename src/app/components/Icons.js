...
// uptrend icon for sidebar
export const UptrendIcon = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const BoxTickIcon = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export const GreenGraph = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="106"
...
export const RedGraph = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="106"
...
export const DownTrendIcon = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="10"
...
export const RotateBox = ({ className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
